object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(127); 
  ...
  val theUltimateAnswer: String = "To life, the universe, and everything is 65.";System.out.println("""theUltimateAnswer  : String = """ + $show(theUltimateAnswer ));$skip(37); 
  ...
  val dobroPi : Double = 2 * pi;System.out.println("""dobroPi  : Double = """ + $show(dobroPi ));$skip(41); 
  println("Double of Pi is :" + dobroPi);$skip(49); 
  println(f"Double of Pi is about $dobroPi%.3f")}
}
