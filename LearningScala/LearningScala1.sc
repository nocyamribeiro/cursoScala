object LearningScala1 {
  ...
  val theUltimateAnswer: String = "To life, the universe, and everything is 65."
                                                  //> theUltimateAnswer  : String = To life, the universe, and everything is 65.
  val pattern = """.* ([\d]+).*""".r              //> pattern  : scala.util.matching.Regex = .* ([\d]+).*
  val pattern(answerString) = theUltimateAnswer   //> answerString  : String = 65
  val answer = answerString.toInt                 //> answer  : Int = 65
  println(answer)                                 //> 65
  ...
  val dobroPi : Double = 2 * pi                   //> dobroPi  : Double = 6.2831853
  println("Double of Pi is :" + dobroPi)          //> Double of Pi is :6.2831853
  println(f"Double of Pi is about $dobroPi%.3f")  //> Double of Pi is about 6,283
}